...
const Footer = () => {
  return (
    <footer className="bg-dark/80 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/#services" className="text-gray-400 hover:text-primary transition-colors">Software Development</Link></li>
              <li><Link href="/#services" className="text-gray-400 hover:text-primary transition-colors">AI Automation</Link></li>
              <li><Link href="/#services" className="text-gray-400 hover:text-primary transition-colors">Digital Marketing</Link></li>
              <li><Link href="/#services" className="text-gray-400 hover:text-primary transition-colors">Web Design</Link></li>
              <li><Link href="/#services" className="text-gray-400 hover:text-primary transition-colors">Mobile Apps</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/#portfolio" className="text-gray-400 hover:text-primary transition-colors">Our Work</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">123 Tech Street, Innovation City</span>
              </li>
              <li className="flex items-start space-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">info@quantifai.com</span>
              </li>
            </ul>
          </div>
        </div>
